...
define('CAMPAIGN_ID', "e8cfd127b80f2cdedd4c2e920a350250");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '12ac3db663334c03fb0e2d80386f31d9');
define('MP_PARAM_NAME', '__oa__');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '4733d8a6dbed5c575ff0b201b09df033');
define('CHECK_MCPROXY_VALUE', 'eb72fde8eed7fa711676690833279f2fa757e18f3341d0a212aabcad95f9efac');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '5146.3');
